var G=i=>{throw TypeError(i)};var P=(i,e,t)=>e.has(i)||G("Cannot "+t);var g=(i,e,t)=>(P(i,e,"read from private field"),t?t.call(i):e.get(i)),E=(i,e,t)=>e.has(i)?G("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(i):e.set(i,t),v=(i,e,t,o)=>(P(i,e,"write to private field"),o?o.call(i,t):e.set(i,t),t),p=(i,e,t)=>(P(i,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();(function(){window.onerror=function(i,e,t,o,a){return console.error("Global error caught:",{message:i,source:e,lineno:t,colno:o,error:a}),i.includes("Cannot read properties of undefined")?(console.error("Property access error detected. Details:",{message:i,source:e,lineno:t,colno:o}),window.hasShownErrorMessage||(window.hasShownErrorMessage=!0,setTimeout(()=>{window.hasShownErrorMessage=!1},5e3),window.location.hash.includes("error")||window.showToast("Terjadi kesalahan saat menampilkan konten. Kami akan mencoba memperbaikinya secara otomatis.","warning")),!0):!1},window.showToast=function(i,e="info"){const t=document.getElementById("toast-container");if(!t)return;const o=document.createElement("div");o.className=`toast toast-${e}`,o.setAttribute("role","alert");const a=document.createElement("i");a.className=`fas ${e==="success"?"fa-check-circle":e==="error"?"fa-exclamation-circle":e==="warning"?"fa-exclamation-triangle":"fa-info-circle"}`,a.setAttribute("aria-hidden","true");const r=document.createElement("span");r.textContent=i,o.appendChild(a),o.appendChild(r),t.appendChild(o),requestAnimationFrame(()=>{setTimeout(()=>{o.classList.add("show")},10)}),setTimeout(()=>{o.classList.remove("show"),setTimeout(()=>{t.contains(o)&&t.removeChild(o)},300)},5e3)}})();(function(){const i=document.getElementById("connection-status"),e=document.getElementById("connection-message");if(!i||!e)return;function t(){navigator.onLine?(i.classList.add("online"),i.classList.remove("offline"),e.textContent="Koneksi telah pulih",setTimeout(()=>{i.classList.add("hidden")},3e3)):(i.classList.remove("online"),i.classList.add("offline"),i.classList.remove("hidden"),e.textContent="Anda sedang offline")}t(),window.addEventListener("online",t),window.addEventListener("offline",t)})();const l={BASE_URL:"https://story-api.dicoding.dev/v1",DEFAULT_LANGUAGE:"id-ID",CACHE_NAME:"DicodingStory-V5",DATABASE_NAME:"dicoding-story-database",DATABASE_VERSION:1,OBJECT_STORE_NAME:"stories",DEFAULT_MAP_CENTER:[-6.1754,106.8272],DEFAULT_MAP_ZOOM:13,PAGE_SIZE:10,API_TIMEOUT:3e4,API_RETRY_ATTEMPTS:2,API_RETRY_DELAY:1e3,MAX_PHOTO_SIZE:5*1024*1024,MAP_TILE_LAYERS:{osm:{url:"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',name:"OpenStreetMap"},satellite:{url:"https://api.maptiler.com/maps/hybrid/{z}/{x}/{y}.jpg?key=WlHVW3GmIbcYKHpoc75N",attribution:'<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',name:"Satellite"},dark:{url:"https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',name:"Dark Mode"}},VAPID_PUBLIC_KEY:"BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk",SERVICE_WORKER_PATH:"./sw.js",OFFLINE_PAGE:"./offline.html"};class w{static async _fetchWithTimeout(e,t={},o=0){const a=new AbortController,{signal:r}=a,s={...t,signal:r,mode:"cors",credentials:"same-origin"},c=setTimeout(()=>{a.abort()},l.API_TIMEOUT);try{if(t.body instanceof FormData&&t.onProgress&&t.method==="POST")return await this._uploadWithProgress(e,t);const n=await fetch(e,s);if(!n.ok){const h=await n.json().catch(()=>({}));let m=h.message||`HTTP error! status: ${n.status}`;if(n.status===400){m=h.message||"Bad Request: The server could not process your request.";const I=new Error(m);throw I.status=n.status,I.data=h,I}else n.status===401?(m="Your session has expired. Please login again.",setTimeout(()=>{window.location.hash="#/login"},2e3)):n.status===403?m="You don't have permission to perform this action.":n.status===404?m="The requested resource was not found.":n.status===413?m="The file you are trying to upload is too large.":n.status>=500&&(m="Server error. Please try again later.");throw new Error(m)}return await n.json()}catch(n){if(n.name==="AbortError"){if(console.warn(`Request timed out: ${e}`),o<l.API_RETRY_ATTEMPTS)return console.log(`Retrying request (${o+1}/${l.API_RETRY_ATTEMPTS})...`),await new Promise(u=>setTimeout(u,l.API_RETRY_DELAY)),this._fetchWithTimeout(e,t,o+1);throw new Error("Request timed out. Please check your internet connection and try again.")}if(n.message==="Failed to fetch"||n.message.includes("NetworkError")||n.message.includes("CORS")){if(console.error("Network or CORS error:",n),e.includes("/notifications/"))return console.warn("Notification API request failed - this is expected in development environment"),{status:"failed",error:n.message};window.showToast&&window.showToast("Network connection issue. Please check your internet connection.","warning")}throw n}finally{clearTimeout(c)}}static async _uploadWithProgress(e,t){return new Promise((o,a)=>{const r=new XMLHttpRequest;r.open(t.method||"POST",e),t.headers&&Object.keys(t.headers).forEach(s=>{r.setRequestHeader(s,t.headers[s])}),r.upload.addEventListener("progress",s=>{if(s.lengthComputable&&t.onProgress){const c=Math.round(s.loaded/s.total*100);t.onProgress(c)}}),r.addEventListener("load",()=>{if(r.status>=200&&r.status<300)try{const s=JSON.parse(r.responseText);o(s)}catch{a(new Error("Invalid response format from server"))}else try{const s=JSON.parse(r.responseText);a(new Error(s.message||`HTTP error! status: ${r.status}`))}catch{a(new Error(`HTTP error! status: ${r.status}`))}}),r.addEventListener("error",()=>{a(new Error("Network error occurred"))}),r.addEventListener("abort",()=>{a(new Error("Upload aborted"))}),r.addEventListener("timeout",()=>{a(new Error("Upload timed out"))}),r.send(t.body)})}static async register({name:e,email:t,password:o}){this._validateEmail(t),this._validatePassword(o);try{const a=await this._fetchWithTimeout(`${l.BASE_URL}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,email:t,password:o})});return window.showToast&&window.showToast("Registrasi berhasil! Silakan login.","success"),a}catch(a){throw a.message.includes("email is already taken")?new Error("Email sudah digunakan. Silakan gunakan email lain."):a}}static async login({email:e,password:t}){this._validateEmail(e);try{const o=await this._fetchWithTimeout(`${l.BASE_URL}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})});return window.showToast&&window.showToast(`Selamat datang kembali, ${o.loginResult.name}!`,"success"),o}catch(o){throw o.message.includes("user not found")||o.message.includes("password")?new Error("Email atau password salah. Silakan coba lagi."):o}}static async getAllStories({token:e,page:t=1,size:o=l.PAGE_SIZE,location:a=0}){this._validateToken(e);try{console.log(`Fetching stories data: page=${t}, size=${o}, location=${a}`);const r=await this._fetchWithTimeout(`${l.BASE_URL}/stories?page=${t}&size=${o}&location=${a}`,{headers:{Authorization:`Bearer ${e}`}});if(!r||!r.listStory)throw console.error("Invalid response format from API:",r),new Error("Format respons dari server tidak valid");return console.log(`Successfully fetched ${r.listStory.length} stories`),r}catch(r){throw console.error("Error fetching stories:",r),window.showToast&&window.showToast("Gagal memuat cerita. "+r.message,"error"),r}}static async getStoryDetail({token:e,id:t}){if(this._validateToken(e),!t)throw new Error("ID cerita tidak valid");return this._fetchWithTimeout(`${l.BASE_URL}/stories/${t}`,{headers:{Authorization:`Bearer ${e}`}})}static async addNewStory({token:e,data:t,onProgress:o}){this._validateToken(e);try{if(!t.has("description"))throw new Error("Description is required");if(!t.has("photo"))throw new Error("Photo is required");const a={method:"POST",headers:{Authorization:`Bearer ${e}`},body:t,onProgress:o},r=await this._fetchWithTimeout(`${l.BASE_URL}/stories`,a);return window.showToast&&window.showToast("Cerita berhasil ditambahkan!","success"),r}catch(a){throw console.error("Error adding story:",a),a.message.includes("photo")?new Error("Gagal mengunggah foto. Pastikan ukuran foto tidak melebihi 5MB."):a.status===400?new Error("Bad request: Pastikan semua data yang dikirim valid (foto dan deskripsi wajib diisi)."):a.message.includes("Network")||a.message.includes("timeout")?new Error("Koneksi gagal. Periksa koneksi internet Anda dan coba lagi."):a}}static async subscribeNotification({token:e,subscription:t}){this._validateToken(e);try{const o=await this._fetchWithTimeout(`${l.BASE_URL}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify(t)});return window.showToast&&window.showToast("Notifikasi berhasil diaktifkan!","success"),o}catch(o){throw console.error("Error subscribing to notifications:",o),window.showToast&&window.showToast("Gagal mengaktifkan notifikasi","error"),o}}static async unsubscribeNotification({token:e,endpoint:t}){if(this._validateToken(e),!t)throw new Error("Endpoint notifikasi tidak valid");try{if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")return console.log("Development environment detected - skipping actual notification unsubscribe request"),window.showToast&&window.showToast("Notifikasi berhasil dinonaktifkan (dev mode)","info"),{success:!0,message:"Unsubscribed from notifications (development mock)"};const a=await this._fetchWithTimeout(`${l.BASE_URL}/notifications/subscribe`,{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({endpoint:t})});return window.showToast&&window.showToast("Notifikasi berhasil dinonaktifkan","info"),a}catch(o){throw console.error("Error unsubscribing from notifications:",o),window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.showToast&&window.showToast("Gagal menonaktifkan notifikasi","error"),o}}static _validateToken(e){if(!e)throw new Error("Autentikasi diperlukan. Silakan login terlebih dahulu.")}static _validateEmail(e){if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e))throw new Error("Silakan masukkan alamat email yang valid")}static _validatePassword(e){if(e.length<8)throw new Error("Password harus minimal 8 karakter")}}class de extends HTMLElement{connectedCallback(){this.render(),this.setupEventListeners(),this.checkNotificationPermission()}render(){const e=localStorage.getItem("token")!==null;let t=null;try{const o=localStorage.getItem("user");o&&o!=="undefined"&&(t=JSON.parse(o))}catch(o){console.error("Failed to parse user data:",o),localStorage.removeItem("user")}this.innerHTML=`
              ...
              ${e?`
                    ...
                    <li class="user-menu">
                      <div class="user-info" tabindex="0" aria-haspopup="true" aria-expanded="false">
                        <div class="user-avatar" aria-hidden="true">${ue(t==null?void 0:t.name)}</div>
    ...
    `}setupEventListeners(){this._setupDrawerToggle(),this._setupUserMenu(),this._setupLogoutButton(),this._setupNotificationToggle(),this._setupThemeToggle()}_setupDrawerToggle(){const e=this.querySelector("#drawer-button"),t=this.querySelector("#navigation-drawer");!e||!t||(e.addEventListener("click",o=>{o.stopPropagation();const a=t.classList.toggle("open");if(e.setAttribute("aria-expanded",a),a){const r=t.querySelector("a");r&&r.focus()}}),document.addEventListener("click",o=>{t.contains(o.target)||(t.classList.remove("open"),e.setAttribute("aria-expanded","false"))}),document.addEventListener("keydown",o=>{o.key==="Escape"&&(t.classList.remove("open"),e.setAttribute("aria-expanded","false"),e.focus())}))}_setupUserMenu(){const e=this.querySelector(".user-menu");if(!e)return;const t=e.querySelector(".user-info"),o=e.querySelector(".user-dropdown");t.addEventListener("click",a=>{a.stopPropagation();const r=t.getAttribute("aria-expanded")==="true";t.setAttribute("aria-expanded",!r),o.style.display=r?"none":"block"}),document.addEventListener("click",()=>{t.setAttribute("aria-expanded","false"),o.style.display="none"}),t.addEventListener("keydown",a=>{if(a.key==="Enter"||a.key===" "){a.preventDefault();const r=t.getAttribute("aria-expanded")==="true";if(t.setAttribute("aria-expanded",!r),o.style.display=r?"none":"block",!r){const s=o.querySelector("button");s&&s.focus()}}})}_setupThemeToggle(){const e=this.querySelector("#theme-toggle");if(!e)return;const t=document.documentElement.getAttribute("data-theme")==="dark",o=e.querySelector("i"),a=e.querySelector("span");t&&(o.classList.replace("fa-moon","fa-sun"),a.textContent="Light Mode"),e.addEventListener("click",()=>{const s=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s);const c=e.querySelector("i"),n=e.querySelector("span");s==="dark"?(c.classList.replace("fa-moon","fa-sun"),n.textContent="Light Mode"):(c.classList.replace("fa-sun","fa-moon"),n.textContent="Dark Mode"),window.showToast&&window.showToast(`${s==="dark"?"Dark":"Light"} mode activated`,"info")})}_setupLogoutButton(){const e=this.querySelector("#logout-button");e&&e.addEventListener("click",()=>{Swal.fire({title:"Logout",text:"Are you sure you want to logout?",icon:"question",showCancelButton:!0,confirmButtonColor:"#4361ee",cancelButtonColor:"#f72585",confirmButtonText:"Yes, Logout",cancelButtonText:"Cancel",focusCancel:!0}).then(t=>{t.isConfirmed&&(this._cleanupNotifications(),localStorage.removeItem("token"),localStorage.removeItem("user"),window.showToast&&window.showToast("Logout successful","success"),window.location.hash="#/login")})})}async _cleanupNotifications(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const t=await(await navigator.serviceWorker.ready).pushManager.getSubscription();t&&(await t.unsubscribe(),console.log("Cleaned up push subscription on logout"))}catch(e){console.error("Error cleaning up notifications on logout:",e)}}async checkNotificationPermission(){const e=this.querySelector("#notification-toggle"),t=this.querySelector("#notification-status"),o=this.querySelector(".status-indicator");!e||!t||!o||(Notification.permission==="granted"?await this._checkActiveSubscription()?(t.textContent="Disable Notifications",o.classList.add("active"),e.classList.add("enabled")):(t.textContent="Enable Notifications",o.classList.remove("active"),e.classList.remove("enabled")):Notification.permission==="denied"?(t.textContent="Notifications Blocked",e.disabled=!0,e.classList.add("blocked"),o.classList.add("blocked")):(t.textContent="Enable Notifications",o.classList.remove("active"),e.classList.remove("enabled")))}async _checkActiveSubscription(){if(!("serviceWorker"in navigator)||!("PushManager"in window))return!1;try{return!!await(await navigator.serviceWorker.ready).pushManager.getSubscription()}catch(e){return console.error("Error checking subscription:",e),!1}}_setupNotificationToggle(){const e=this.querySelector("#notification-toggle"),t=this.querySelector("#notification-status"),o=this.querySelector(".status-indicator");!e||!t||!o||e.addEventListener("click",async()=>{if(e.disabled)return;e.disabled=!0,e.classList.add("loading");const a=t.textContent;t.textContent="Processing...";try{if(await this._checkActiveSubscription())await this._unsubscribeFromNotifications(),t.textContent="Enable Notifications",o.classList.remove("active"),e.classList.remove("enabled");else if(Notification.permission==="granted")await this._subscribeToNotifications(),t.textContent="Disable Notifications",o.classList.add("active"),e.classList.add("enabled");else{const s=await Notification.requestPermission();s==="granted"?(await this._subscribeToNotifications(),t.textContent="Disable Notifications",o.classList.add("active"),e.classList.add("enabled")):s==="denied"&&(t.textContent="Notifications Blocked",e.disabled=!0,e.classList.add("blocked"),o.classList.add("blocked"),window.showToast&&window.showToast("Notification permission denied by browser","warning"))}}catch(r){console.error("Error toggling notifications:",r),t.textContent=a,window.showToast&&window.showToast("Failed to toggle notifications","error")}finally{e.disabled=!1,e.classList.remove("loading")}})}async _subscribeToNotifications(){if(!("serviceWorker"in navigator)||!("PushManager"in window)){console.log("Push notifications are not supported");return}const e=localStorage.getItem("token");if(e)try{const t=await navigator.serviceWorker.ready,o=await t.pushManager.getSubscription();o&&await o.unsubscribe();const r=(await t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:l.VAPID_PUBLIC_KEY})).toJSON(),{endpoint:s,keys:c}=r,n={endpoint:s,keys:c};return await w.subscribeNotification({token:e,subscription:n}),console.log("Successfully subscribed to notifications"),window.showToast&&window.showToast("Notifications enabled successfully","success"),!0}catch(t){return console.error("Error subscribing to notifications:",t),window.showToast&&window.showToast("Failed to enable notifications","error"),!1}}async _unsubscribeFromNotifications(){const e=localStorage.getItem("token");if(!e)return!1;try{const o=await(await navigator.serviceWorker.ready).pushManager.getSubscription();if(o){try{await w.unsubscribeNotification({token:e,endpoint:o.endpoint})}catch(r){console.warn("API unsubscribe notification failed (expected in development):",r)}const a=await o.unsubscribe();return console.log("Successfully unsubscribed from push notification service"),window.showToast&&window.showToast("Notifications disabled successfully","info"),a}return!0}catch(t){return console.error("Error unsubscribing from notifications:",t),!(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&window.showToast&&window.showToast("Failed to disable notifications","error"),!1}}}customElements.define("app-header",de);function ue(i){return i?i.split(" ").map(e=>e.charAt(0)).join("").toUpperCase():"U"}function oe(i,e="id-ID",t={}){const o={year:"numeric",month:"long",day:"numeric",...t};try{return new Date(i).toLocaleDateString(e,o)}catch(a){return console.error("Error formatting date:",a),i||"Unknown date"}}function he(i,e=300,t=!1){let o;return function(...r){const s=this,c=()=>{o=null,t||i.apply(s,r)},n=t&&!o;clearTimeout(o),o=setTimeout(c,e),n&&i.apply(s,r)}}function M(i){const e=["Bytes","KB","MB","GB"],t=Math.floor(Math.log(i)/Math.log(1024));return parseFloat((i/Math.pow(1024,t)).toFixed(2))+" "+e[t]}function ae(i){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i)}class me extends HTMLElement{set story(e){this._story=e,this.render()}render(){if(this._story)try{const e={id:this._story.id||`unknown-${Date.now()}`,name:this._story.name||"Unknown User",description:this._story.description||"No description provided",photoUrl:this._story.photoUrl||"./images/placeholder.jpg",createdAt:this._story.createdAt||new Date().toISOString(),lat:this._story.lat,lon:this._story.lon},t=oe(e.createdAt,"id-ID",{year:"numeric",month:"long",day:"numeric"}),o=`story-title-${e.id}`,a=`story-desc-${e.id}`,r=W(e.name);this.innerHTML=`
          ...
          <div class="story-content">
            <div class="story-header">
              <div class="story-user">
                <div class="user-avatar" aria-hidden="true" style="background-color: ${r}">
                  ${pe(e.name)}
                </div>
                <div>
            ...
            <p class="story-description" id="${a}">${J(e.description,120)}</p>
      ...
      `}}renderMap(){try{if(!this._story){console.error("Cannot render map: story data is missing");return}const e=parseFloat(this._story.lat),t=parseFloat(this._story.lon);if(isNaN(e)||isNaN(t)){console.error("Cannot render map: invalid coordinates",{lat:this._story.lat,lon:this._story.lon});return}const o=this._story.id||`unknown-${Date.now()}`,a=this._story.name||"Unknown User",r=this._story.description||"",s=this.querySelector(`#map-${o}`);if(!s||!window.L){console.error("Cannot render map: DOM element or Leaflet not available");return}const c=L.map(s,{zoomControl:!1,dragging:!1,touchZoom:!1,scrollWheelZoom:!1,doubleClickZoom:!1,boxZoom:!1,keyboard:!1,attributionControl:!1}).setView([e,t],13);L.tileLayer(l.MAP_TILE_LAYERS.osm.url,{maxZoom:19}).addTo(c);const n=W(a),u=L.divIcon({html:`<div style="background-color: ${n}; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; box-shadow: 0 2px 5px rgba(0,0,0,0.3);">
          ...
          </div>`,{className:"custom-popup",closeButton:!1}).openPopup(),c.on("click",()=>{window.location.hash=`#/stories/${o}`}),s.addEventListener("keydown",h=>{(h.key==="Enter"||h.key===" ")&&(window.location.hash=`#/stories/${o}`)})}catch(e){console.error("Error rendering map:",e,{story:this._story})}}connectedCallback(){try{if("IntersectionObserver"in window&&window.matchMedia("(prefers-reduced-motion: no-preference)").matches){const e=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting&&(this.classList.add("visible"),e.unobserve(this))})},{threshold:.2});e.observe(this)}else this.classList.add("visible")}catch(e){console.error("Error in connectedCallback:",e),this.classList.add("visible")}}}customElements.define("app-card",me);function pe(i){if(typeof i!="string")return"U";try{return i.split(" ").map(e=>e.charAt(0)).join("").toUpperCase().substring(0,2)}catch(e){return console.error("Error getting initials:",e,{name:i}),"U"}}function W(i){const e=["#4361ee","#3f37c9","#4895ef","#4cc9f0","#f72585","#7209b7","#3a0ca3","#4cc9f0","#f72585","#f8961e"];if(!i||typeof i!="string")return e[0];const t=i.split("").reduce((o,a)=>a.charCodeAt(0)+((o<<5)-o),0);return e[Math.abs(t)%e.length]}function J(i,e=100){if(!i||typeof i!="string")return"";try{return i.length<=e?i:`${i.substring(0,e)}...`}catch(t){return console.error("Error truncating text:",t,{text:i}),""}}class fe extends HTMLElement{constructor(){super(),this.message="Loading..."}static get observedAttributes(){return["message"]}attributeChangedCallback(e,t,o){e==="message"&&t!==o&&(this.message=o,this.renderMessage())}connectedCallback(){this.render(),this.hide()}show(e=""){e&&(this.message=e,this.renderMessage()),this.style.display="flex"}hide(){this.style.display="none"}render(){this.innerHTML=`
      <div class="loading-spinner">
        <div class="spinner"></div>
        <p class="loading-message">${this.message}</p>
      </div>
    `}renderMessage(){const e=this.querySelector(".loading-message");e&&(e.textContent=this.message)}}customElements.define("app-loader",fe);class ge extends HTMLElement{connectedCallback(){this.render(),this.setupEventListeners()}render(){const e=new Date().getFullYear();this.innerHTML=`
    ...
    `}_getInitials(e){return!e||typeof e!="string"?"?":e.split(" ").map(t=>t.charAt(0)).join("").toUpperCase().substring(0,2)}_getAvatarColor(e){if(!e)return"#4361ee";const t=["#4361ee","#3a0ca3","#f72585","#4cc9f0","#4895ef","#560bad","#f8961e","#fb5607","#80b918"];let o=0;for(let a=0;a<e.length;a++)o=e.charCodeAt(a)+((o<<5)-o);return t[Math.abs(o)%t.length]}_bindEvents(){const e=this.querySelector("#sidebar-toggle");this.querySelector("#sidebar");const t=this.querySelector("#sidebar-overlay"),o=this.querySelector("#sidebar-close");e&&e.addEventListener("click",()=>this._toggleSidebar()),o&&o.addEventListener("click",()=>this._closeSidebar()),t&&t.addEventListener("click",()=>this._closeSidebar());const a=this.querySelector("#logout-button");a&&a.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("user-logout",{bubbles:!0,composed:!0})),this._closeSidebar()}),this.querySelectorAll(".sidebar-link").forEach(s=>{s.addEventListener("click",()=>this._closeSidebar())})}_toggleSidebar(){try{const e=this.querySelector("#sidebar"),t=this.querySelector("#sidebar-overlay");if(!e||!t)return;e.classList.contains("open")?this._closeSidebar():(e.classList.add("open"),t.classList.add("visible"),document.body.classList.add("sidebar-open"))}catch(e){console.error("Error toggling sidebar:",e)}}_closeSidebar(){try{const e=this.querySelector("#sidebar"),t=this.querySelector("#sidebar-overlay");if(!e||!t)return;e.classList.remove("open"),t.classList.remove("visible"),document.body.classList.remove("sidebar-open")}catch(e){console.error("Error closing sidebar:",e)}}_isActiveRoute(e){const t=window.location.hash||"#/";return!!(t===e||e==="#/stories/add"&&t.includes("#/stories/add")||e==="#/stories"&&t.includes("#/stories/")&&!t.includes("#/stories/add"))}}customElements.define("app-sidebar",we);const q=(i,e)=>e.some(t=>i instanceof t);let Y,K;function ve(){return Y||(Y=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ye(){return K||(K=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const $=new WeakMap,A=new WeakMap,T=new WeakMap;function be(i){const e=new Promise((t,o)=>{const a=()=>{i.removeEventListener("success",r),i.removeEventListener("error",s)},r=()=>{t(b(i.result)),a()},s=()=>{o(i.error),a()};i.addEventListener("success",r),i.addEventListener("error",s)});return T.set(e,i),e}function _e(i){if($.has(i))return;const e=new Promise((t,o)=>{const a=()=>{i.removeEventListener("complete",r),i.removeEventListener("error",s),i.removeEventListener("abort",s)},r=()=>{t(),a()},s=()=>{o(i.error||new DOMException("AbortError","AbortError")),a()};i.addEventListener("complete",r),i.addEventListener("error",s),i.addEventListener("abort",s)});$.set(i,e)}let N={get(i,e,t){if(i instanceof IDBTransaction){if(e==="done")return $.get(i);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return b(i[e])},set(i,e,t){return i[e]=t,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function ie(i){N=i(N)}function Se(i){return ye().includes(i)?function(...e){return i.apply(F(this),e),b(this.request)}:function(...e){return b(i.apply(F(this),e))}}function Ee(i){return typeof i=="function"?Se(i):(i instanceof IDBTransaction&&_e(i),q(i,ve())?new Proxy(i,N):i)}function b(i){if(i instanceof IDBRequest)return be(i);if(A.has(i))return A.get(i);const e=Ee(i);return e!==i&&(A.set(i,e),T.set(e,i)),e}const F=i=>T.get(i);function j(i,e,{blocked:t,upgrade:o,blocking:a,terminated:r}={}){const s=indexedDB.open(i,e),c=b(s);return o&&s.addEventListener("upgradeneeded",n=>{o(b(s.result),n.oldVersion,n.newVersion,b(s.transaction),n)}),t&&s.addEventListener("blocked",n=>t(n.oldVersion,n.newVersion,n)),c.then(n=>{r&&n.addEventListener("close",()=>r()),a&&n.addEventListener("versionchange",u=>a(u.oldVersion,u.newVersion,u))}).catch(()=>{}),c}const Le=["get","getKey","getAll","getAllKeys","count"],ke=["put","add","delete","clear"],D=new Map;function Z(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(D.get(e))return D.get(e);const t=e.replace(/FromIndex$/,""),o=e!==t,a=ke.includes(t);if(!(t in(o?IDBIndex:IDBObjectStore).prototype)||!(a||Le.includes(t)))return;const r=async function(s,...c){const n=this.transaction(s,a?"readwrite":"readonly");let u=n.store;return o&&(u=u.index(c.shift())),(await Promise.all([u[t](...c),a&&n.done]))[0]};return D.set(e,r),r}ie(i=>({...i,get:(e,t,o)=>Z(e,t)||i.get(e,t,o),has:(e,t)=>!!Z(e,t)||i.has(e,t)}));const Ce=["continue","continuePrimaryKey","advance"],X={},O=new WeakMap,re=new WeakMap,Te={get(i,e){if(!Ce.includes(e))return i[e];let t=X[e];return t||(t=X[e]=function(...o){O.set(this,re.get(this)[e](...o))}),t}};async function*Ie(...i){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...i)),!e)return;e=e;const t=new Proxy(e,Te);for(re.set(t,e),T.set(t,F(e));e;)yield t,e=await(O.get(t)||e.continue()),O.delete(t)}function Q(i,e){return e===Symbol.asyncIterator&&q(i,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&q(i,[IDBIndex,IDBObjectStore])}ie(i=>({...i,get(e,t,o){return Q(e,t)?Ie:i.get(e,t,o)},has(e,t){return Q(e,t)||i.has(e,t)}}));const se="dicoding-story-db",C="stories";async function ee(i){const t=(await j(se,1,{upgrade(o){o.objectStoreNames.contains(C)||o.createObjectStore(C,{keyPath:"id"})}})).transaction(C,"readwrite");for(const o of i)await t.store.put(o);await t.done}async function Pe(){return(await j(se,1)).getAll(C)}class Me{constructor({view:e}){this._view=e,this._page=1,this._hasMoreData=!0,this._isLoading=!1,this._includeLocation=!1}async init(){try{this._view.renderPage(),this._setupEventListeners(),await this._loadInitialStories()}catch(e){console.error("Error in HomePresenter.init:",e),this._view.showError("Error initializing page. Please try refreshing.")}}_setupEventListeners(){try{this._view.setLoadMoreCallback(async()=>{await this._loadMoreStories()}),this._view.setLocationFilterCallback(e=>{this._includeLocation=e,this._page=1,this._hasMoreData=!0,this._loadInitialStories()})}catch(e){console.error("Error setting up event listeners:",e)}}async _loadInitialStories(){if(!this._isLoading){this._isLoading=!0,this._page=1;try{this._view.clearStories(),this._view.showLoading();const e=localStorage.getItem("token");if(!e){this._view.showLoginRequired();return}console.log("Fetching initial stories, page:",this._page,"location:",this._includeLocation?1:0);const t=await w.getAllStories({token:e,page:this._page,location:this._includeLocation?1:0});if(t.error){this._view.showError(t.message||"Gagal memuat cerita");return}if(!t||typeof t!="object"){console.error("Invalid response format:",t),this._view.showError("Format respons server tidak valid");return}const o=t.listStory||[],a=t.size||10;if(console.log("Received stories:",o.length),!Array.isArray(o)){console.error("Stories is not an array:",o),this._view.showError("Format data cerita tidak valid");return}o.length===0?(this._view.showEmptyState(),this._hasMoreData=!1):(await ee(o),this._view.renderStories(o),this._hasMoreData=o.length===a,this._view.updateLoadMoreButton(this._hasMoreData))}catch(e){console.error("Error loading initial stories:",e);const t=await Pe();t&&t.length>0?(this._view.renderStories(t),this._view.showOfflineMessage()):this._view.showError(e.message||"Gagal memuat cerita")}finally{this._isLoading=!1,this._view.hideLoading()}}}async _loadMoreStories(){if(!(this._isLoading||!this._hasMoreData)){this._isLoading=!0,this._page+=1;try{this._view.showLoadingMore();const e=localStorage.getItem("token");if(!e){this._view.showLoginRequired();return}console.log("Fetching more stories, page:",this._page,"location:",this._includeLocation?1:0);const t=await w.getAllStories({token:e,page:this._page,location:this._includeLocation?1:0});if(t.error){this._view.showError(t.message||"Gagal memuat cerita tambahan");return}if(!t||typeof t!="object"){console.error("Invalid response format:",t),this._view.showError("Format respons server tidak valid");return}const o=t.listStory||[],a=t.size||10;if(console.log("Received more stories:",o.length),!Array.isArray(o)){console.error("Stories is not an array:",o),this._view.showError("Format data cerita tidak valid");return}o.length>0?(await ee(o),this._view.appendStories(o),this._hasMoreData=o.length===a):this._hasMoreData=!1,this._view.updateLoadMoreButton(this._hasMoreData)}catch(e){console.error("Error loading more stories:",e),this._view.showError(e.message||"Gagal memuat cerita tambahan")}finally{this._isLoading=!1,this._view.hideLoadingMore()}}}}class Ae{constructor(){this._presenter=new Me({view:this}),this._debouncedScroll=he(this._handleScroll.bind(this),200)}renderPage(){this._setupInfiniteScroll(),this._setupOfflineListener()}async render(){return`
    ...
    `}async afterRender(){this._presenter.init()}setLoadMoreCallback(e){const t=document.querySelector("#load-more");t&&t.addEventListener("click",e)}setLocationFilterCallback(e){const t=document.querySelector("#include-location");t&&t.addEventListener("change",o=>{e(o.target.checked)})}_setupInfiniteScroll(){window.addEventListener("scroll",this._debouncedScroll)}_handleScroll(){const e=document.querySelector("#load-more");if(!e||e.style.display==="none"||e.disabled)return;const t=window.scrollY,o=document.documentElement.clientHeight,a=document.documentElement.scrollHeight;o+t>=a-100&&e.click()}_setupOfflineListener(){window.addEventListener("online",()=>{this._presenter.init()})}showLoading(){const e=document.querySelector("app-loader");e&&e.show("Loading stories...")}hideLoading(){const e=document.querySelector("app-loader");e&&e.hide()}showLoadingMore(){const e=document.querySelector("#loading-more");e&&e.classList.remove("hidden")}hideLoadingMore(){const e=document.querySelector("#loading-more");e&&e.classList.add("hidden")}clearStories(){const e=document.querySelector("#stories-list");e&&(e.innerHTML="");const t=document.querySelector("#empty-state");t&&t.classList.add("hidden")}renderStories(e){const t=document.querySelector("#stories-list");if(!t)return;if(!e||!Array.isArray(e)){console.error("Invalid stories data:",e);return}e.filter(a=>a&&typeof a=="object").forEach((a,r)=>{try{const s=document.createElement("app-card");s.story=a,t.appendChild(s),window.matchMedia("(prefers-reduced-motion: no-preference)").matches&&s.animate([{opacity:0,transform:"translateY(20px)"},{opacity:1,transform:"translateY(0)"}],{duration:300,easing:"ease-out",delay:r*50})}catch(s){console.error("Error rendering story card:",s,{story:a})}})}appendStories(e){const t=document.querySelector("#stories-list");if(!t)return;if(!e||!Array.isArray(e)){console.error("Invalid stories data:",e);return}const o=e.filter(a=>a&&typeof a=="object");if(o.length===0){console.warn("No valid stories to append");return}t.childElementCount,o.forEach((a,r)=>{try{const s=document.createElement("app-card");s.story=a,t.appendChild(s),window.matchMedia("(prefers-reduced-motion: no-preference)").matches&&s.animate([{opacity:0,transform:"translateY(20px)"},{opacity:1,transform:"translateY(0)"}],{duration:300,easing:"ease-out",delay:r*50})}catch(s){console.error("Error appending story card:",s,{story:a})}})}updateLoadMoreButton(e){const t=document.querySelector("#load-more");t&&(e?(t.style.display="flex",t.disabled=!1):(t.style.display="none",t.disabled=!0))}showEmptyState(){const e=document.querySelector("#empty-state");e&&e.classList.remove("hidden");const t=document.querySelector("#load-more");t&&(t.style.display="none")}showLoginRequired(){Swal.fire({icon:"warning",title:"Login Required",text:"You need to login to view stories",confirmButtonText:"Login Now",confirmButtonColor:"#4361ee"}).then(e=>{e.isConfirmed&&(window.location.hash="#/login")})}showOfflineMessage(){window.showToast&&window.showToast("Anda sedang offline. Menampilkan data tersimpan.","info")}showError(e){Swal.fire({icon:"error",title:"Error",text:e||"Failed to load stories",confirmButtonColor:"#4361ee"})}}class De{async render(){return`
      ...
      <app-footer></app-footer>
    `}async afterRender(){window.matchMedia("(prefers-reduced-motion: no-preference)").matches&&[document.getElementById("about-app"),document.getElementById("about-features"),document.getElementById("about-tech"),document.getElementById("about-developer")].forEach((t,o)=>{t&&(t.style.opacity="0",t.style.transform="translateY(20px)",t.style.transition="opacity 0.3s ease, transform 0.3s ease",setTimeout(()=>{t.style.opacity="1",t.style.transform="translateY(0)"},o*100+300))})}}class xe{async render(){return`
      <app-sidebar></app-sidebar>
      <app-header></app-header>
      <main id="main-content" class="main-content" tabindex="-1">
      ...
      <app-footer></app-footer>
      <app-loader></app-loader>
    `}async afterRender(){this._setupForm(),this._setupInputValidation(),this._checkRememberedUser()}_setupForm(){const e=document.querySelector("#login-form");e&&e.addEventListener("submit",async t=>{if(t.preventDefault(),!this._validateForm())return;const o=e.querySelector("#email").value.trim(),a=e.querySelector("#password").value.trim(),r=e.querySelector("#remember-me").checked,s=document.querySelector("app-loader");s&&s.show("Authenticating...");try{const c=await w.login({email:o,password:a});localStorage.setItem("token",c.loginResult.token),localStorage.setItem("user",JSON.stringify(c.loginResult.user)),r?localStorage.setItem("rememberedEmail",o):localStorage.removeItem("rememberedEmail"),await Swal.fire({icon:"success",title:"Login successful!",showConfirmButton:!1,timer:1500}),window.location.hash="#/"}catch(c){console.error("Login failed:",c),Swal.fire({icon:"error",title:"Login failed",text:c.message||"Invalid email or password",confirmButtonColor:"#4361ee"})}finally{s&&s.hide()}})}_setupInputValidation(){const e=document.querySelector("#email"),t=document.querySelector("#password");e&&e.addEventListener("input",()=>{this._validateEmail()}),t&&t.addEventListener("input",()=>{this._validatePassword()})}_validateForm(){const e=this._validateEmail(),t=this._validatePassword();return e&&t}_validateEmail(){const e=document.querySelector("#email"),t=document.querySelector("#email-error");if(!e||!t)return!1;const o=e.value.trim();return o?ae(o)?(t.textContent="",!0):(t.textContent="Please enter a valid email address",!1):(t.textContent="Email is required",!1)}_validatePassword(){const e=document.querySelector("#password"),t=document.querySelector("#password-error");if(!e||!t)return!1;const o=e.value.trim();return o?o.length<8?(t.textContent="Password must be at least 8 characters",!1):(t.textContent="",!0):(t.textContent="Password is required",!1)}_checkRememberedUser(){const e=localStorage.getItem("rememberedEmail"),t=document.querySelector("#email"),o=document.querySelector("#remember-me");e&&t&&(t.value=e,o&&(o.checked=!0),document.querySelector("#password").focus())}}class Be{async render(){return`
      <app-sidebar></app-sidebar>
      <app-header></app-header>
      <main id="main-content" class="main-content" tabindex="-1">
        <section class="auth-container">
    ...
    `}async afterRender(){this._setupForm(),this._setupInputValidation()}_setupForm(){const e=document.querySelector("#register-form");e&&e.addEventListener("submit",async t=>{if(t.preventDefault(),!this._validateForm())return;const o=e.querySelector("#name").value.trim(),a=e.querySelector("#email").value.trim(),r=e.querySelector("#password").value.trim(),s=document.querySelector("app-loader");s&&s.show("Creating account...");try{await w.register({name:o,email:a,password:r}),await Swal.fire({icon:"success",title:"Registration successful!",text:"Please login with your new account",confirmButtonColor:"#4361ee"}),window.location.hash="#/login",e.reset()}catch(c){console.error("Registration failed:",c),Swal.fire({icon:"error",title:"Registration failed",text:c.message||"Email may already be registered",confirmButtonColor:"#4361ee"})}finally{s&&s.hide()}})}_setupInputValidation(){const e=document.querySelector("#name"),t=document.querySelector("#email"),o=document.querySelector("#password");e&&e.addEventListener("input",()=>{this._validateName()}),t&&t.addEventListener("input",()=>{this._validateEmail()}),o&&o.addEventListener("input",()=>{this._validatePassword()})}_validateForm(){const e=this._validateName(),t=this._validateEmail(),o=this._validatePassword();return e&&t&&o}_validateName(){const e=document.querySelector("#name"),t=document.querySelector("#name-error");if(!e||!t)return!1;const o=e.value.trim();return o?o.length<3?(t.textContent="Name must be at least 3 characters",!1):(t.textContent="",!0):(t.textContent="Name is required",!1)}_validateEmail(){const e=document.querySelector("#email"),t=document.querySelector("#email-error");if(!e||!t)return!1;const o=e.value.trim();return o?ae(o)?(t.textContent="",!0):(t.textContent="Please enter a valid email address",!1):(t.textContent="Email is required",!1)}_validatePassword(){const e=document.querySelector("#password"),t=document.querySelector("#password-error");if(!e||!t)return!1;const o=e.value.trim();return o?o.length<8?(t.textContent="Password must be at least 8 characters",!1):(t.textContent="",!0):(t.textContent="Password is required",!1)}}class qe{constructor({view:e,id:t}){this._view=e,this._id=t,this._map=null,this._story=null,this._mapInitialized=!1}async init(){this._view.renderPage(),await this._loadStoryDetail(),this._setupOnlineListener(),this._setupActions()}async _loadStoryDetail(){try{this._view.showLoading();const e=localStorage.getItem("token");if(!e){this._view.showLoginRequired();return}const t=this._getCachedStory();try{const o=await w.getStoryDetail({token:e,id:this._id});if(o.error)throw new Error(o.message||"Gagal memuat cerita");this._story=o.story,this._cacheStory(o.story),this._view.renderStoryDetail(o.story),this._view.hideOfflineMessage(),this._story.lat&&this._story.lon&&this._initMapWithDelay(300)}catch(o){console.error("API error:",o),t?(console.log("Loading from cache instead"),this._story=t,this._view.renderStoryDetail(t),this._view.showOfflineMessage(),t.lat&&t.lon&&!this._mapInitialized&&this._initMapWithDelay(300)):this._view.showError(o.message)}}catch(e){console.error("Unexpected error:",e);const t=this._getCachedStory();t?(this._story=t,this._view.renderStoryDetail(t),this._view.showOfflineMessage(),t.lat&&t.lon&&!this._mapInitialized&&this._initMapWithDelay(300)):this._view.showError("Terjadi kesalahan. Silakan coba lagi.")}finally{this._view.hideLoading()}}_setupOnlineListener(){window.addEventListener("online",()=>{this._story?this._view.hideOfflineMessage():this._loadStoryDetail()}),window.addEventListener("offline",()=>{this._story&&this._view.showOfflineMessage()})}_initMapWithDelay(e=100){if(!window.L){console.error("Leaflet library not available");return}setTimeout(()=>{this._initMap()},e)}_initMap(){if(this._mapInitialized)return;if(!this._story){console.error("Cannot initialize map: story is undefined");return}const e=parseFloat(this._story.lat),t=parseFloat(this._story.lon);if(isNaN(e)||isNaN(t)){console.error("Cannot initialize map: invalid coordinates",{lat:this._story.lat,lon:this._story.lon});return}const o=this._view.getMapContainer();if(!o){console.error("Cannot initialize map: container not found");return}try{console.log("Initializing map with coordinates:",e,t),this._map=L.map(o).setView([e,t],13);const a=this._createBaseMaps();a.Street.addTo(this._map),L.control.layers(a,{},{position:"topright"}).addTo(this._map),this._addStoryMarker(),this._addLocateControl(),this._updateMapSize(),this._mapInitialized=!0,console.log("Map initialization complete")}catch(a){console.error("Error initializing map:",a),this._view.showMapError()}}_createBaseMaps(){const e={};return e.Street=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',maxZoom:19}),e.Satellite=L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:"Tiles &copy; Esri &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community",maxZoom:19}),e.Dark=L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',maxZoom:19}),e.Topographic=L.tileLayer("https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png",{attribution:'Map data: &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, <a href="http://viewfinderpanoramas.org">SRTM</a> | Map style: &copy; <a href="https://opentopomap.org">OpenTopoMap</a> (<a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA</a>)',maxZoom:17}),e}_addStoryMarker(){if(!this._map){console.error("Cannot add marker: map is not initialized");return}if(!this._story){console.error("Cannot add marker: story is undefined");return}try{const e=parseFloat(this._story.lat),t=parseFloat(this._story.lon);if(isNaN(e)||isNaN(t)){console.error("Cannot add marker: invalid coordinates",{lat:this._story.lat,lon:this._story.lon});return}const o=this._story.name||"Untitled Story",a=this._story.description||"",r=`
      ...
      <app-footer></app-footer>
      <app-loader></app-loader>
    `}async afterRender(){this._presenter.init();const e=document.getElementById("save-story-button");e&&this._story&&e.addEventListener("click",async()=>{await k.addToFavorites(this._story),window.showToast&&window.showToast("Cerita disimpan ke halaman Favorit!","success")})}renderStoryDetail(e){const t=document.querySelector("#story-content");if(!e||!t)return;const o=e.name||"Unknown User",a=e.description||"No description provided",r=e.photoUrl||"./images/placeholder.jpg",s=e.createdAt||new Date().toISOString(),c=oe(s,"id-ID",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}),n=this._getUserColor(o),u=`story-title-${e.id}`,h=`story-desc-${e.id}`,m=this._isInFavorites(e.id);t.innerHTML=`
    ...
    `,e.lat&&e.lon&&(this._mapContainer=document.getElementById("detail-map")),this._setupFavoriteButton(m)}getMapContainer(){return this._mapContainer}showLoading(){const e=document.querySelector("app-loader");e&&e.show("Loading story...")}hideLoading(){const e=document.querySelector("app-loader");e&&e.hide()}showOfflineMessage(){const e=document.getElementById("offline-notice");e&&e.classList.remove("hidden")}hideOfflineMessage(){const e=document.getElementById("offline-notice");e&&e.classList.add("hidden")}showOfflineNoDataMessage(){Swal.fire({icon:"warning",title:"Offline",text:"This story is not available offline. Please connect to the internet and try again.",confirmButtonColor:"#4361ee"}).then(()=>{window.location.hash="#/"})}showLoginRequired(){Swal.fire({icon:"warning",title:"Login Required",text:"Please login to view story details",confirmButtonText:"Login Now",confirmButtonColor:"#4361ee"}).then(()=>{window.location.hash="#/login"})}showInvalidIdError(){Swal.fire({icon:"error",title:"Invalid Story ID",text:"The story ID is missing or invalid",confirmButtonColor:"#4361ee"}).then(()=>{window.location.hash="#/"})}showError(e){Swal.fire({icon:"error",title:"Error",text:e||"Failed to load story",confirmButtonColor:"#4361ee"}).then(()=>{window.location.hash="#/"})}showTimeoutError(){const e=document.getElementById("offline-notice");e&&(e.innerHTML=`
      ...
      `)}_getUrlParams(){const t=window.location.hash.match(/#\/stories\/([^/]+)$/);return{id:t?t[1]:null}}_getInitials(e){return!e||typeof e!="string"?"U":e.split(" ").map(t=>t.charAt(0)).join("").toUpperCase().substring(0,2)}_getUserColor(e){const t=["#4361ee","#3f37c9","#4895ef","#4cc9f0","#f72585","#7209b7","#3a0ca3","#4cc9f0","#f72585","#f8961e"],o=e.split("").reduce((a,r)=>r.charCodeAt(0)+((a<<5)-a),0);return t[Math.abs(o)%t.length]}_isInFavorites(e){try{const t=localStorage.getItem("favoriteStories");if(!t)return!1;const o=JSON.parse(t);return Array.isArray(o)&&o.includes(e)}catch(t){return console.error("Error checking favorites:",t),!1}}_setupFavoriteButton(e){const t=document.getElementById("favorite-button");t&&t.addEventListener("click",()=>{const a=!t.classList.contains("active");a?(t.classList.add("active"),t.setAttribute("aria-label","Remove from favorites")):(t.classList.remove("active"),t.setAttribute("aria-label","Add to favorites")),this._favoriteCallback&&this._favoriteCallback(a)})}setFavoriteButtonCallback(e){this._favoriteCallback=e}showShareButton(){const e=document.getElementById("share-button");e&&e.classList.remove("hidden")}setShareButtonCallback(e){const t=document.getElementById("share-button");t&&t.addEventListener("click",e)}animateRemoval(e){const t=document.getElementById("story-article");if(!t){e&&e();return}t.style.transition="all 0.5s ease-out",t.style.opacity="0",t.style.transform="scale(0.9)",setTimeout(()=>{e&&e()},500)}cancelRemovalAnimation(){const e=document.getElementById("story-article");e&&(e.style.opacity="1",e.style.transform="scale(1)")}}class Fe{constructor({view:e}){this._view=e,this._photoFile=null,this._map=null,this._marker=null,this._cameraStream=null,this._mapInitialized=!1,window.addEventListener("hashchange",()=>{this.stopCamera()}),window.addEventListener("beforeunload",()=>{this.stopCamera()})}init(){this._setupForm(),this._setupPhotoPreview(),this._setupCamera(),this._setupLocationCheckbox(),this._setupInputValidation(),this._setupAutoSaveDraft(),this._checkMediaPermissions()}loadRecentDrafts(){try{const e=localStorage.getItem("recentDrafts");if(!e){this._view.displayRecentDrafts([]);return}const t=JSON.parse(e);this._view.displayRecentDrafts(t)}catch(e){console.error("Error loading recent drafts:",e),this._view.displayRecentDrafts([])}}useDraft(e){try{const t=localStorage.getItem("recentDrafts");if(!t)return;const a=JSON.parse(t).find(r=>r.id===e);if(a){let r=a.fullDescription||a.description;this._view.applyDraftToForm(r)}}catch(t){console.error("Error using draft:",t)}}_checkMediaPermissions(){navigator.permissions&&navigator.permissions.query&&navigator.permissions.query({name:"camera"}).then(e=>{if(console.log("Camera permission status:",e.state),e.state==="denied"){const t=document.querySelector("#camera-button");t&&(t.classList.add("permission-denied"),t.title="Camera permission denied. Please update your browser settings.")}e.onchange=()=>{console.log("Camera permission status changed to:",e.state);const t=document.querySelector("#camera-button");t&&(e.state==="denied"?(t.classList.add("permission-denied"),t.title="Camera permission denied. Please update your browser settings."):(t.classList.remove("permission-denied"),t.title=""))}}).catch(e=>{console.log("Error checking camera permission:",e)})}stopCamera(){if(this._cameraStream){try{this._cameraStream.getTracks().forEach(t=>t.stop())}catch(e){console.error("Error stopping camera tracks:",e)}this._cameraStream=null,this._view&&this._view.resetCameraUI()}}_setupAutoSaveDraft(){let e;const t=document.querySelector("#description");t&&t.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{this._saveDraft(t.value)},3e4)})}_saveDraft(e){if(!(!e||e.trim().length<5))try{const t=localStorage.getItem("recentDrafts");let o=t?JSON.parse(t):[];const a=e.substring(0,50)+(e.length>50?"...":""),r={id:Date.now().toString(),description:a,fullDescription:e,timestamp:new Date().toISOString()};o.unshift(r),o=o.slice(0,5),localStorage.setItem("recentDrafts",JSON.stringify(o)),window.showToast&&window.showToast("Draft saved automatically","info")}catch(t){console.error("Error saving draft:",t)}}_setupForm(){this._view.setSubmitCallback(async e=>{const t=localStorage.getItem("token");if(!t){await this._view.showLoginRequiredAlert(),window.location.hash="#/login";return}if(!this._validateForm()){this._view.showFormValidationError();return}if(!e.has("description")||!e.get("description").trim()){this._view.showDescriptionError("Description is required"),this._view.showFormValidationError();return}if(!e.has("photo")||!e.get("photo"))if(this._photoFile)e.set("photo",this._photoFile);else{this._view.showPhotoError("Please select or take a photo"),this._view.showFormValidationError();return}this._view.showLoader("Saving your story..."),this._view.showProgressBar();try{await w.addNewStory({token:t,data:e,onProgress:o=>{this._view.updateProgressBar(o)}}),this._view.updateProgressBar(100),setTimeout(()=>{this._view.hideProgressBar()},500),await this._view.showSuccessAlert(),this._view.showConfetti(),this._addToRecents(e.get("description")),setTimeout(()=>{window.location.hash="#/",this._view.resetForm(),this.stopCamera()},1e3)}catch(o){this._view.hideProgressBar(),this._view.showErrorAlert(o.message)}finally{this._view.hideLoader()}})}_setupPhotoPreview(){this._view.setPhotoInputCallback(e=>{if(e){if(e.size>l.MAX_PHOTO_SIZE){this._view.showPhotoError(`File too large. Maximum size is ${M(l.MAX_PHOTO_SIZE)}`);return}if(!["image/jpeg","image/png","image/jpg"].includes(e.type)){this._view.showPhotoError("Only JPEG and PNG images are allowed");return}this._photoFile=e,this._view.clearPhotoError(),this._view.showPhotoPreview(e)}})}_setupCamera(){this._view.setOpenCameraCallback(async()=>{try{if(!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia)throw new Error("Your browser does not support camera access");this.stopCamera();const e=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1280},height:{ideal:720}},audio:!1});this._cameraStream=e,this._view.showCameraStream(e),window.addEventListener("beforeunload",()=>{this.stopCamera()},{once:!0})}catch(e){if(console.error("Error accessing camera:",e),e.name==="NotAllowedError")this._view.showCameraError("Camera access denied. Please allow camera access in your browser settings.");else if(e.name==="NotFoundError")this._view.showCameraError("No camera found on your device or camera is in use by another application.");else if(e.name==="NotReadableError")this._view.showCameraError("Could not access camera. Your camera might be in use by another application.");else if(e.name==="OverconstrainedError")try{const t=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});this._cameraStream=t,this._view.showCameraStream(t)}catch{this._view.showCameraError("Could not access camera with requested settings. Please try a different device.")}else this._view.showCameraError("Could not access camera: "+(e.message||"Unknown error"))}}),this._view.setTakePhotoCallback(()=>{if(!this._cameraStream){console.error("Cannot take photo: Camera stream is not available"),this._view.showCameraError("Camera is not ready. Please try again.");return}try{const e=this._view.capturePhoto();if(!e){console.error("Failed to capture photo: null data URL"),this._view.showCameraError("Failed to capture photo");return}this._view.showCameraFlash();const t="camera-photo-"+new Date().getTime()+".jpg",o=this._dataURLToFile(e,t);if(!o){console.error("Failed to convert data URL to file"),this._view.showCameraError("Failed to process captured photo");return}if(o.size>l.MAX_PHOTO_SIZE){this._view.showPhotoError(`File too large. Maximum size is ${M(l.MAX_PHOTO_SIZE)}`);return}this._photoFile=o,this._view.showPhotoPreview(o),window.showToast&&window.showToast("Photo captured successfully!","success"),setTimeout(()=>{this.stopCamera()},500)}catch(e){console.error("Error taking photo:",e),this._view.showCameraError("Error capturing photo: "+e.message)}}),this._view.setCloseCameraCallback(()=>{this.stopCamera()})}_dataURLToFile(e,t){try{if(!e||typeof e!="string"||!e.startsWith("data:image/"))return console.error("Invalid data URL format"),null;const o=e.split(",");if(o.length!==2)return console.error("Invalid data URL structure"),null;const a=o[0].match(/:(.*?);/);if(!a||a.length<2)return console.error("Could not extract MIME type from data URL"),null;const r=a[1],s=atob(o[1]);let c=s.length;const n=new Uint8Array(c);for(;c--;)n[c]=s.charCodeAt(c);return new File([n],t,{type:r})}catch(o){return console.error("Error converting data URL to file:",o),null}}_setupLocationCheckbox(){this._view.setLocationCheckboxCallback(e=>{e?(this._view.showMapContainer(),this._mapInitialized?this._map&&this._map.invalidateSize():setTimeout(()=>{this._initMap()},300)):this._view.hideMapContainer()})}_setupInputValidation(){this._view.setDescriptionInputCallback(e=>{this._validateDescription(e)})}_validateDescription(e){return e?e.length<10?(this._view.showDescriptionError("Description must be at least 10 characters"),!1):["judi","poker","togel","seks","adult","xxx"].some(a=>e.toLowerCase().includes(a))?(this._view.showDescriptionError("Your story may contain inappropriate content. Please revise."),!1):(this._view.clearDescriptionError(),!0):(this._view.showDescriptionError("Please enter a description"),!1)}_validateForm(){const e=this._validateDescription(this._view.getDescription()),t=this._validatePhoto();return e&&t}_validatePhoto(){if(!this._photoFile){const e=document.querySelector("#photo");if(e&&e.files.length>0)this._photoFile=e.files[0];else{const t=document.querySelector("#photo-preview img");if(!t||t.classList.contains("hidden"))return this._view.showPhotoError("Please select or take a photo"),!1}}return this._photoFile&&this._photoFile.size>l.MAX_PHOTO_SIZE?(this._view.showPhotoError(`File too large. Maximum size is ${M(l.MAX_PHOTO_SIZE)}`),!1):!0}_initMap(){if(!window.L){console.error("Leaflet library not loaded!"),this._view.showMapError("Map library not loaded. Please check your internet connection and reload the page.");return}try{if(!document.getElementById("map")){console.error("Map container element not found");return}if(console.log("Initializing map..."),this._map=L.map("map",{zoomControl:!0,attributionControl:!0}).setView(l.DEFAULT_MAP_CENTER,l.DEFAULT_MAP_ZOOM),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',maxZoom:19}).addTo(this._map),setTimeout(()=>{this._map&&(console.log("Invalidating map size"),this._map.invalidateSize())},100),this._mapInitialized=!0,window.L.Control&&window.L.Control.Geocoder){const t=L.Control.Geocoder.nominatim({geocodingQueryParams:{countrycodes:"id",limit:5}});L.Control.geocoder({defaultMarkGeocode:!1,geocoder:t,placeholder:"Search for places...",errorMessage:"Nothing found.",suggestMinLength:3,suggestTimeout:250,queryMinLength:1}).addTo(this._map).on("markgeocode",a=>{const{lat:r,lng:s}=a.geocode.center;this._updateLocation(r,s),this._map.setView([r,s],15)})}else console.warn("Geocoder control not available");window.L.control&&window.L.control.locate?L.control.locate({position:"topright",strings:{title:"Temukan lokasi saya"},locateOptions:{enableHighAccuracy:!0,maxZoom:15},flyTo:!0}).addTo(this._map):console.warn("Locate control not available"),this._map.on("click",t=>{this._updateLocation(t.latlng.lat,t.latlng.lng)}),this._view.setLocateMeCallback(()=>{"geolocation"in navigator?(this._view.showLoader("Finding your location..."),navigator.geolocation.getCurrentPosition(t=>{this._view.hideLoader();const{latitude:o,longitude:a}=t.coords;this._updateLocation(o,a),this._map.setView([o,a],15),window.showToast&&window.showToast("Location found!","success")},t=>{this._view.hideLoader(),console.error("Geolocation error:",t);let o="Could not get your location.";switch(t.code){case t.PERMISSION_DENIED:o="Location access denied. Please check your browser settings.";break;case t.POSITION_UNAVAILABLE:o="Location information is unavailable.";break;case t.TIMEOUT:o="Location request timed out.";break}this._view.showMapError(o)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:0})):this._view.showMapError("Geolocation is not supported by your browser")}),this._view.setSearchLocationCallback(()=>{const t=document.querySelector(".leaflet-control-geocoder");if(t)try{const o=t.querySelector(".leaflet-control-geocoder-icon"),a=t.querySelector("input");o&&o.click(),a&&a.focus()}catch(o){console.error("Error expanding geocoder:",o),this._showLocationSearchPrompt()}else this._showLocationSearchPrompt()}),console.log("Map initialization complete")}catch(e){console.error("Error initializing map:",e),this._view.showMapError("Failed to initialize map: "+e.message)}}_showLocationSearchPrompt(){Swal.fire({title:"Search Location",input:"text",inputPlaceholder:"Enter a place or address",showCancelButton:!0,confirmButtonColor:"#4361ee",cancelButtonColor:"#6c757d",confirmButtonText:"Search",showLoaderOnConfirm:!0,preConfirm:e=>{if(!e){Swal.showValidationMessage("Please enter a location");return}return fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(e)}&limit=5`).then(t=>{if(!t.ok)throw new Error("Network response was not ok");return t.json()}).catch(t=>{Swal.showValidationMessage(`Search failed: ${t.message}`)})},allowOutsideClick:()=>!Swal.isLoading()}).then(e=>{if(e.isConfirmed&&e.value&&e.value.length>0){const t=e.value;if(t.length===1){const o=t[0],a=parseFloat(o.lat),r=parseFloat(o.lon);this._updateLocation(a,r),this._map&&this._map.setView([a,r],15)}else if(t.length>1){const o=t.map(a=>({text:a.display_name,value:a.place_id,lat:parseFloat(a.lat),lon:parseFloat(a.lon)}));Swal.fire({title:"Select Location",input:"radio",inputOptions:o.reduce((a,r,s)=>(a[r.value]=r.text,a),{}),showCancelButton:!0,confirmButtonColor:"#4361ee",confirmButtonText:"Select"}).then(a=>{if(a.isConfirmed){const r=o.find(s=>s.value.toString()===a.value);r&&(this._updateLocation(r.lat,r.lon),this._map&&this._map.setView([r.lat,r.lon],15))}})}else Swal.fire({icon:"info",title:"No Results",text:"No locations found for your search."})}})}_updateLocation(e,t){if(this._view.updateLocationCoordinates(e,t),this._marker?this._marker.setLatLng([e,t]):this._map&&(this._marker=L.marker([e,t],{draggable:!0,autoPan:!0}).addTo(this._map),this._marker.on("dragend",o=>{const r=o.target.getLatLng();this._updateLocation(r.lat,r.lng)})),this._map){this._map.setView([e,t],this._map.getZoom()||15);const o=document.getElementById("location-text");o&&(o.innerHTML=`
        ...
        `),this._reverseGeocode(e,t)}}_reverseGeocode(e,t){if(window.L&&window.L.Control&&window.L.Control.Geocoder)try{const o=L.Control.Geocoder.nominatim();if(o){o.reverse({lat:e,lng:t},this._map.getZoom(),a=>{if(a&&a.length>0){const r=a[0].name,s=document.getElementById("location-text");s&&r&&(s.innerHTML=`
                ...
                <br>Coordinates: ${e.toFixed(6)}, ${t.toFixed(6)}
              `)}}).catch(o=>{console.warn("Nominatim reverse geocoding failed:",o);const a=document.getElementById("location-text");a&&(a.textContent=`Coordinates: ${e.toFixed(6)}, ${t.toFixed(6)}`)})}catch(o){console.warn("External reverse geocoding failed:",o)}}_addToRecents(e){try{const t=localStorage.getItem("recentDrafts");let o=t?JSON.parse(t):[];const a=e.substring(0,50)+(e.length>50?"...":"");o.unshift({description:a,timestamp:new Date().toISOString(),id:Date.now().toString()}),o=o.slice(0,5),localStorage.setItem("recentDrafts",JSON.stringify(o))}catch(t){console.error("Error saving to recents:",t)}}}class Oe{constructor(){this._presenter=new Fe({view:this})}async render(){return`
      <app-sidebar></app-sidebar>
      <app-header></app-header>
      <main id="main-content" class="main-content" tabindex="-1">
        <section class="container">
    ...
    `}async afterRender(){this._presenter.init(),this._presenter.loadRecentDrafts(),this._setupCharCounter()}_setupCharCounter(){const e=document.getElementById("description"),t=document.getElementById("char-count");e&&t&&e.addEventListener("input",()=>{const o=e.value.length;t.textContent=o,o>240?t.classList.add("text-warning"):o>270?(t.classList.remove("text-warning"),t.classList.add("text-danger")):t.classList.remove("text-warning","text-danger")})}displayRecentDrafts(e){const t=document.getElementById("recent-drafts");if(!t)return;if(!e||!Array.isArray(e)||e.length===0){t.classList.add("hidden");return}t.classList.remove("hidden");let o='<h2 class="recent-drafts-title">Recent Drafts</h2><div class="recent-drafts-list">';e.forEach(a=>{const s=new Date(a.timestamp).toLocaleDateString("id-ID",{day:"numeric",month:"short"});o+=`
      ...
      <app-footer></app-footer>
    `}async afterRender(){}}const Ue={isLoggedIn(){return!!localStorage.getItem("token")},getToken(){return localStorage.getItem("token")},logout(){localStorage.removeItem("token"),window.location.hash="#/login"}};class He{constructor(){this._title="Cerita Favorit - DicoStory"}async render(){return document.title=this._title,`
    ...
    `}async afterRender(){if(!Ue.isLoggedIn()){window.location.href="#/login";return}this.showLoading();try{const e=await k.getFavorites();this.renderFavorites(e)}catch(e){console.error("Error loading favorites:",e),this.showError("Gagal memuat cerita favorit: "+e.message)}}showLoading(){const e=document.getElementById("favorites-loader");e&&e.classList.remove("hidden");const t=document.getElementById("error-container");t&&t.classList.add("hidden")}hideLoading(){const e=document.getElementById("favorites-loader");e&&e.classList.add("hidden")}async renderFavorites(e){this.hideLoading();const t=document.getElementById("favorites-container");if(t){if(!e||e.length===0){t.innerHTML=`
        <div class="empty-state">
          <p>Belum ada cerita favorit.</p>
          <a href="#/" class="btn btn-primary">Jelajahi Cerita</a>
        </div>
      `;return}t.innerHTML="",e.forEach(o=>{const a=o.name.charAt(0).toUpperCase(),r=document.createElement("article");r.classList.add("story-card"),r.innerHTML=`
        <div class="story-image-container">
          <img
            src="${o.photoUrl}"
            alt="Cerita dari ${o.name}"
            class="story-image"
            loading="lazy"
        ...
        <div class="story-content">
          ...
          <h3 class="story-title">${o.name}</h3>
          <p class="story-description">${this._truncateText(o.description,100)}</p>
          <div class="story-meta">
            <div class="story-info">
              <i class="fas fa-calendar-alt"></i>
              <span>${this._formatDate(o.createdAt)}</span>
            </div>
            ${o.lat&&o.lon?`<div class="story-info">
                <i class="fas fa-map-marker-alt"></i>
                <span>Lokasi tersedia</span>
              </div>`:""}
          </div>
          <div class="story-actions">
            <button class="remove-favorite-btn" data-id="${o.id}">
              <i class="fas fa-trash"></i> Hapus
            </button>
            <a href="#/stories/${o.id}" class="view-details-btn" data-id="${o.id}">
              Detail
            </a>
          </div>
        </div>
      `,t.appendChild(r),r.querySelector(".remove-favorite-btn").addEventListener("click",async c=>{c.preventDefault(),await k.removeFromFavorites(o.id),r.remove(),(await k.getFavorites()).length===0&&this.renderFavorites([]),window.showToast&&window.showToast("Cerita dihapus dari Favorit","info")})})}}showError(e){this.hideLoading();const t=document.getElementById("error-container");if(!t)return;t.classList.remove("hidden"),t.innerHTML=`
    ...
    `;const o=document.getElementById("retry-button");o&&o.addEventListener("click",async()=>{this.showLoading();try{const a=await k.getFavorites();this.renderFavorites(a)}catch(a){this.showError("Gagal memuat cerita favorit: "+a.message)}})}_truncateText(e,t){return e?e.length<=t?e:e.substr(0,t)+"...":""}_formatDate(e){if(!e)return"-";const t={year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"};return new Date(e).toLocaleDateString("id-ID",t)}}const x={"#/":Ae,"#/about":De,"#/login":xe,"#/register":Be,"#/stories/:id":Ne,"#/stories/add":Oe,"#/saved":He,"#/404":Re};function ne(i){const t=i.split("?")[0].split("/").filter(o=>o!=="");return{resource:t[0]||null,id:t[1]&&t[1]!=="add"?t[1]:null,isAddPage:t[1]==="add"}}function ce(){return location.hash.replace("#","")||"/"}function ze(){const i=ce(),{resource:e,id:t,isAddPage:o}=ne(i);let a="#/";return e&&(a=`#/${e}`),o&&(a+="/add"),t&&(a+="/:id"),a}function Ve(){return ne(ce())}var y,f,S,d,le,R,U,H,z,V;class je{constructor({content:e}){E(this,d);E(this,y,null);E(this,f,null);E(this,S,null);v(this,y,e),document.addEventListener("user-logout",()=>{localStorage.removeItem("token"),localStorage.removeItem("user"),window.showToast("Logout berhasil","success"),window.location.hash="#/login"})}async renderPage(){const e=ze(),{resource:t,id:o,isAddPage:a}=Ve();if(p(this,d,le).call(this),a){const c=new x["#/stories/add"];p(this,d,R).call(this,t,o),p(this,d,U).call(this);try{await document.startViewTransition(async()=>{if(g(this,y).innerHTML=await c.render(),await c.afterRender(),c._presenter&&v(this,f,c._presenter),v(this,S,e),p(this,d,V).call(this),window.matchMedia("(prefers-reduced-motion: no-preference)").matches){const n=document.getElementById("main-content");n&&n.animate([{transform:"translateX(100%)",opacity:0},{transform:"translateX(0)",opacity:1}],{duration:300,easing:"ease-out"})}}).finished}catch(n){console.error("Error rendering Add Story page:",n),p(this,d,z).call(this)}finally{p(this,d,H).call(this)}return}const r=x[e]||x["#/404"],s=new r;p(this,d,R).call(this,t,o),p(this,d,U).call(this);try{await document.startViewTransition(async()=>{if(g(this,y).innerHTML=await s.render(),await s.afterRender(),s._presenter&&v(this,f,s._presenter),v(this,S,e),p(this,d,V).call(this),window.matchMedia("(prefers-reduced-motion: no-preference)").matches){const c=document.getElementById("main-content");c&&c.animate([{transform:"translateX(-50px)",opacity:0},{transform:"translateX(0)",opacity:1}],{duration:300,easing:"ease-out"})}}).finished}catch(c){console.error("Error rendering page:",c),p(this,d,z).call(this)}finally{p(this,d,H).call(this)}}}y=new WeakMap,f=new WeakMap,S=new WeakMap,d=new WeakSet,le=function(){g(this,S)==="#/stories/add"&&g(this,f)&&typeof g(this,f).stopCamera=="function"&&g(this,f).stopCamera(),v(this,f,null)},R=function(e,t){const o={stories:t?"Story Details":"Add Story",login:"Login",register:"Register",about:"About",default:"Home"},a=o[e]||o.default;document.title=`Dicoding Story | ${a}`},U=function(){const e=document.querySelector("app-loader");e&&e.show()},H=function(){const e=document.querySelector("app-loader");e&&e.hide()},z=function(){g(this,y).innerHTML=`
      <app-sidebar></app-sidebar>
      <section class="container">
    ...
    `},V=function(){try{const e=localStorage.getItem("token"),t=localStorage.getItem("user");if(e&&t&&t!=="undefined")try{const o=JSON.parse(t);window.dispatchEvent(new CustomEvent("user-login-state-changed",{detail:{isLoggedIn:!0,userData:o}}))}catch(o){console.error("Invalid user data in localStorage:",o),localStorage.removeItem("user");const a={name:"User",email:""};localStorage.setItem("user",JSON.stringify(a)),window.dispatchEvent(new CustomEvent("user-login-state-changed",{detail:{isLoggedIn:!0,userData:a}}))}else window.dispatchEvent(new CustomEvent("user-login-state-changed",{detail:{isLoggedIn:!1,userData:null}}))}catch(e){console.error("Error updating sidebar:",e)}};function Ge(i){const e="=".repeat((4-i.length%4)%4),t=(i+e).replace(/-/g,"+").replace(/_/g,"/"),o=window.atob(t);return Uint8Array.from([...o].map(a=>a.charCodeAt(0)))}async function We(i){try{if(await Notification.requestPermission()!=="granted"){console.log("Push notification permission denied");return}const t=localStorage.getItem("token");if(!t){console.warn("User not logged in, cannot subscribe to push notifications");return}const o=Ge(l.VAPID_PUBLIC_KEY),a=await i.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:o}),{endpoint:r,keys:s}=a.toJSON(),c={endpoint:r,keys:s};await fetch(`${l.BASE_URL}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify(c)}),console.log("User subscribed to push notifications")}catch(e){console.error("Failed to subscribe user:",e)}}function Je(){const i=document.createElement("div");i.className="splash-screen";const e=document.createElement("img");e.src="/images/logo.png",e.alt="Dicoding Story Logo",e.className="splash-logo";const t=document.createElement("div");t.className="splash-title",t.textContent="Dicoding Story";const o=document.createElement("div");o.className="splash-dots";for(let a=0;a<3;a++){const r=document.createElement("div");r.className="splash-dot",o.appendChild(r)}return i.appendChild(e),i.appendChild(t),i.appendChild(o),document.body.appendChild(i),i}function B(i){i.style.opacity="0",setTimeout(()=>{i.style.visibility="hidden",document.body.removeChild(i)},600)}"serviceWorker"in navigator&&(window.addEventListener("beforeinstallprompt",i=>{i.preventDefault();let e=i;const t=document.createElement("button");t.id="install-button",t.textContent="Install App",t.className="install-button",document.body.appendChild(t),t.addEventListener("click",async()=>{t.style.display="none",e.prompt();const{outcome:o}=await e.userChoice;console.log(`User response to the install prompt: ${o}`),e=null})}),window.addEventListener("load",()=>{navigator.serviceWorker.register(l.SERVICE_WORKER_PATH).then(i=>{console.log("ServiceWorker registration successful with scope: ",i.scope),window.showToast&&window.showToast("Aplikasi siap digunakan secara offline","success"),We(i)}).catch(i=>{console.error("ServiceWorker registration failed: ",i),window.showToast&&window.showToast("Gagal mendaftarkan service worker","error")})}));const Ye=()=>"startViewTransition"in document&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches;Ye()||(document.startViewTransition=i=>{try{const e=Promise.resolve(i());return{ready:Promise.resolve(),updateCallbackDone:e,finished:e}}catch(e){return console.error("Error in startViewTransition callback:",e),{ready:Promise.reject(e),updateCallbackDone:Promise.reject(e),finished:Promise.reject(e)}}});function Ke(){const i=localStorage.getItem("theme");i?document.documentElement.setAttribute("data-theme",i):window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(document.documentElement.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"))}Ke();async function Ze(){const i=Je();setTimeout(async()=>{const e=document.querySelector("#app");if(!e){console.error("App element not found"),B(i);return}const t=new je({content:e});try{await t.renderPage(),B(i),Xe(),Qe(),te()}catch(s){console.error("Error loading initial page:",s),B(i),e.innerHTML=`
        <section class="container">
          <h1 class="page-title">Error</h1>
          <p>Gagal memuat halaman. Silakan coba lagi.</p>
          <a href="#/" class="back-link">
      ...
      `,window.showToast&&window.showToast("Gagal memuat halaman, silakan coba lagi","error")}window.addEventListener("hashchange",async()=>{try{const s=document.createElement("div");s.className="loading-spinner",s.innerHTML=`
        ...
        `,document.body.appendChild(s),await t.renderPage(),te(),document.body.removeChild(s)}catch(s){console.error("Error loading page:",s),window.showToast&&window.showToast("Gagal memuat halaman","error")}});const o=()=>{const s=document.querySelector(".skip-link");s&&s.addEventListener("click",function(c){c.preventDefault();const n=document.querySelector("#main-content");n&&(s.blur(),n.focus(),n.scrollIntoView({behavior:"smooth"}))})};o(),window.addEventListener("hashchange",()=>{setTimeout(o,100)});let a;const r=document.createElement("div");r.id="install-container",r.classList.add("install-prompt"),r.innerHTML=`
    ...
    `,document.body.appendChild(r),window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),a=s,setTimeout(()=>{r.classList.add("show")},3e3),document.getElementById("install-button").addEventListener("click",()=>{r.classList.remove("show"),a.prompt(),a.userChoice.then(c=>{c.outcome==="accepted"?(console.log("User accepted the install prompt"),window.showToast&&window.showToast("Aplikasi sedang diinstall!","success")):console.log("User dismissed the install prompt"),a=null})}),document.getElementById("dismiss-button").addEventListener("click",()=>{r.classList.remove("show")})}),window.showToast&&setTimeout(()=>{window.showToast("Selamat datang di Dicoding Story!","info")},1e3)},1800)}function Xe(){const i=document.querySelector("header");if(!i)return;const e=()=>{window.scrollY>30?i.classList.add("scrolled"):i.classList.remove("scrolled")};e(),window.addEventListener("scroll",e)}function Qe(){const i=localStorage.getItem("theme");i&&document.documentElement.setAttribute("data-theme",i);const e=document.querySelector(".nav-list");if(e&&!document.getElementById("theme-toggle-item")){const t=document.createElement("li");t.id="theme-toggle-item";const o=i||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");t.innerHTML=`
        <button id="theme-toggle" aria-label="Toggle dark/light mode">
          <i class="fas ${o==="dark"?"fa-sun":"fa-moon"}" aria-hidden="true"></i>
          <span>${o==="dark"?"Light Mode":"Dark Mode"}</span>
        </button>
      `;const a=e.children[1];a?e.insertBefore(t,a.nextSibling):e.appendChild(t);const r=document.getElementById("theme-toggle");r&&r.addEventListener("click",et)}}function et(){const e=(document.documentElement.getAttribute("data-theme")||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"))==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e);const t=document.getElementById("theme-toggle");if(t){const o=t.querySelector("i"),a=t.querySelector("span");o&&(o.className=`fas ${e==="dark"?"fa-sun":"fa-moon"}`),a&&(a.textContent=e==="dark"?"Light Mode":"Dark Mode")}window.showToast&&window.showToast(`Switched to ${e==="dark"?"dark":"light"} mode`,"info")}function te(){const i=()=>{document.querySelectorAll(".story-item, .page-title, .story-form, .auth-container").forEach(o=>{const a=o.getBoundingClientRect();if(a.top<=(window.innerHeight||document.documentElement.clientHeight)*.85&&a.bottom>=0)if(o.classList.add("visible"),o.classList.contains("story-item")){o.classList.add("animate__animated","animate__fadeInUp");const s=Array.from(o.parentNode.children).indexOf(o);o.style.animationDelay=`${s*.1}s`}else o.classList.contains("page-title")?o.classList.add("animate__animated","animate__fadeInDown"):o.classList.add("animate__animated","animate__fadeIn")})};setTimeout(i,100);let e;window.addEventListener("scroll",()=>{clearTimeout(e),e=setTimeout(i,20)})}document.addEventListener("DOMContentLoaded",Ze);
//# sourceMappingURL=main-pPB5VrM8.js.map
